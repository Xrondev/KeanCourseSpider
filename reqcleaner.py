...
for page in range(1, max_page_num + 1):
    ...
    for course in info['Sections']:
        ...
        formatted_course = {
            'id': course['Synonym'],  # 课程id，是指代该Section的唯一序列
            'name': course['Course']['SubjectCode'] + '_' + course['Course']['Number'],  # 课程名称，形如 'ACCT_2210'
            'title': course['Course']['Title'],  # 课程标题，形如 'PRINCIPLES OF ACCOUNTING II'
            # 'description': course['Course']['Description'],  # 课程描述
            'section': course['Number'],  # 课程班级号，形如 'W01'
            'prof': course['FacultyDisplay'],  # 列表！教授名称（可能不止一个人）
            'days': meeting_info['days'],  # 形如[[1,3],[2]]，课程所在的工作日顺序，1对应星期一
            'time': meeting_info['time'],  # 形如[['16:00:00', '17:15:00'], ['08:30:00', '11:15:00']], 对应工作日的上课时间
        }
